...
/**
 * Provides the remote service interface for AmfRegistrationAuditLog. Methods of this
...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=amf", "json.web.service.context.path=AmfRegistrationAuditLog"}, service = AmfRegistrationAuditLogService.class)
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface AmfRegistrationAuditLogService extends BaseService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AmfRegistrationAuditLogServiceUtil} to access the amf registration audit log remote service. Add custom service methods to {@link com.liferay.docs.amf.registration.sb.service.impl.AmfRegistrationAuditLogServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public boolean hasPermissionVIEW_ALL_USER_EVENTS(
		ServiceContext serviceContext) throws PrincipalException;
