...
public class AmfRegistrationUtil {
	...
	*/
	public static AmfRegistration create(long dummy) {
		return getPersistence().create(dummy);
	}
	...
	*/
	public static AmfRegistration remove(long dummy)
		throws com.liferay.docs.amf.registration.sb.exception.NoSuchAmfRegistrationException {
		return getPersistence().remove(dummy);
	}
	...
	* @throws NoSuchAmfRegistrationException if a amf registration with the primary key could not be found
	*/
	public static AmfRegistration findByPrimaryKey(long dummy)
		throws com.liferay.docs.amf.registration.sb.exception.NoSuchAmfRegistrationException {
		return getPersistence().findByPrimaryKey(dummy);
	}
	...
	*/
	public static AmfRegistration fetchByPrimaryKey(long dummy) {
		return getPersistence().fetchByPrimaryKey(dummy);
	}
